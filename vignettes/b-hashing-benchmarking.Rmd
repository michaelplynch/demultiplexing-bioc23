...
mu1<-500
mu2<-30
mat<-logimat(ngroups=4,nsinglet=c(2000,1000,2500,150),ndoub=1000,nneg=200)
counts<-draw_counts(size_sig=2.5,size_bg = 3.5,mu_sig = c(mu1*1.2,mu1*0.8,mu1*0.7,mu1*0.9),mu_bg = c(mu2,mu2,mu2,mu2),mat=mat,seed=1)
hto<-SingleCellExperiment(list(counts=counts))
...
ggplot(df, aes(fill=true,x=pred))+geom_bar(position="fill") + scale_fill_manual(values=dittoColors())
````
